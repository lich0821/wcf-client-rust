...
const ripples = {
  show(e: PointerEvent, el: any, value: RippleOptions = {}) {
...
function mounted(el: any, binding: RippleDirectiveBinding) {
...
function updated(el: any, binding: RippleDirectiveBinding) {
